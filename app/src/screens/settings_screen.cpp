...
void SettingsScreen::init() {
  ...
  lv_obj_set_style_text_opa(this->ui_Label23, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(this->ui_Label23, &lv_font_roboto_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_opa(this->ui_Label25, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(this->ui_Label25, &lv_font_roboto_20,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_align(this->ui_Label24, LV_TEXT_ALIGN_CENTER,
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(this->ui_Label24, &lv_font_roboto_34,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
}
...
void SettingsScreen::update() {
  ...
  if (buttons.isPressed(this->color, ButtonType::Accept)) {
    switch (this->buttonIndex) {
      case 0:
        // LOG_INF("Time button pressed\n");
        break;
      case 1:
        // LOG_INF("Mode button pressed\n");
        break;
      case 2:
        // LOG_INF("Open button pressed\n");
        break;
      default:
